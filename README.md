...
| 🟢 | [Agile and Lean organizations: progress not perfection, the only way to build the right product](./tech-speeches.md#agile-and-lean-organizations-progress-not-perfection-the-only-way-to-build-the-right-product) | N/A | N/A | [Luca Legora](https://linkedin.com/in/lucalegora) | |
