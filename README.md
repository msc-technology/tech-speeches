...
| 🟢 | [Agile and Lean organizations: progress not perfection, the only way to build the right product](./tech-speeches.md#agile-and-lean-organizations-progress-not-perfection-the-only-way-to-build-the-right-product) | N/A | [Presentations](https://github.com/msc-technology/agile-and-lean-organizations) | [Luca Legora](https://linkedin.com/in/lucalegora) | |
